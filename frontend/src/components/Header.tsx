  ...
  return (
    <header className="app-header">
      ...
      <div className="app-header-actions">
        ...
        >
          {/* Filled Material-style gear (currentColor, --text-tertiary) --
              swapped from a thin-stroke outline version that read as a
              blurry flower/blob at this button's small (19px) rendered
              size; a solid fill stays crisp and unambiguously reads as a
              gear at that size. */}
